        ...
        <section id="contact" className="contact-section">
            <div className="contact-container">
                <div className="contact-info-panel">
                    ...
                    <h2 className="section-title">Have questions about our products?</h2>
                    <p className="contact-desc">
                        Need help choosing the right tech product? Our expert team is here assist you. 
                    </p>
                    <div className="contact-details">
                        ...
                        <div className="contact-details-item">
                            ...
                            <div className="detail-text">
                                <h4>Location</h4>
                                <p>Vimsa Tech Store, Colombo, Sri Lanka</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="contact-form-panel">
                    <form className="contact-form" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="form-group">
                            ...
                            <textarea id="message" rows="4" placeholder="Which product are you interested in?..." required ></textarea>
                        </div>
